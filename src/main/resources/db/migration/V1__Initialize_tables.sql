...
(
    ...
    status                  ENUM ('PENDING', 'PROCESSING', 'COMPLETE', 'FAILED', 'UNKNOWN_APPROVE') NOT NULL DEFAULT 'PENDING',
...
(
    ...
    previous_status  ENUM ('PENDING', 'PROCESSING', 'COMPLETE', 'FAILED', 'UNKNOWN_APPROVE'),
    new_status       ENUM ('PENDING', 'PROCESSING', 'COMPLETE', 'FAILED', 'UNKNOWN_APPROVE'),
    reason           VARCHAR(255),
