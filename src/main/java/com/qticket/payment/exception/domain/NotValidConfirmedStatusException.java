...
public class NotValidConfirmedStatusException extends RuntimeException {
    ...
    public NotValidConfirmedStatusException(String paymentKey, String orderId, ApprovalStatus approvalStatus) {
        this.message = messageFormat.formatted(paymentKey, orderId, approvalStatus);
    }
